...
<div className = "snap-x flex snap-mandatory overflow-scroll">
    <img src="/images/members/cherin.jpg"  className = "flex-shrink-0  snap-center"/>
    <img src="/images/members/cherin.jpg"  className = "flex-shrink-0  snap-center"/>
    <img src="/images/members/cherin.jpg"  className = "flex-shrink-0  snap-center"/>
</div>

3. video for mobile display 
<video autoPlay loop muted playsInline src={val.videoPath}></video>


4. adding props to Styled Components
